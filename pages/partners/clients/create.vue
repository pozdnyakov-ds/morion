...
<div class="main-content">
    <div class="page-title">
        Создание клиента / рекламодателя партнера
    </div>
        ...
        <v-container style="padding: 0px;">
            ...
            <v-row>
                <v-col cols="6">
                    <v-select
                    label="Роли партнера"
                    :items="[{ id: 1, name: 'Клиент'}, { id: 2, name: 'Рекламодатель'}]"
            ...
            <v-row>
                <v-col>
                    <div style="padding: 0px; margin-bottom: 0px;">
                        <v-btn style="background-color: #fff; color: #333;" outline @click.prevent="router.push('/partners/clients')">Назад</v-btn>
