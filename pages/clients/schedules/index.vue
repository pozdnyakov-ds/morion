<template>
    <div class="main-content">
        ...
        <v-data-table 
            ...
            :headers="headers"
            :items="indexStore.schedules.size ? Array.from(indexStore.schedules.values()).map((item, key) => ({ id: key, ...item })) : []"
            :search="search"
            item-key="id"
                ...
                <v-dialog v-model="dialog.plus" persistent width="auto">
                    <v-form v-model="valid">
                        <v-card class="dialog-plus">
                            <v-card-text class="text-h6">Создать расписание</v-card-text>
                            <v-text-field
...
const dialog_edit_yes = async () => {
    ...
    // console.log("TO SAVE: ", recordInfo)
...
const loadRecords = async () => {
    ...
    if (indexStore.schedules.size) indexStore.schedules.clear()
        ...
        if (data.value.code == 200) {
            ...
            data.value.data.forEach((item, index) => {
                ...
                if (item.content === null) {
                    item.content = {
                        days: [
                            { id: 1, name: 'Пн', status: false, startTime: '00:00', finishTime: '23:59' },
                            { id: 2, name: 'Вт', status: false, startTime: '00:00', finishTime: '23:59' },
                            { id: 3, name: 'Ср', status: false, startTime: '00:00', finishTime: '23:59' },
                            { id: 4, name: 'Чт', status: false, startTime: '00:00', finishTime: '23:59' },
                            { id: 5, name: 'Пт', status: false, startTime: '00:00', finishTime: '23:59' },
                            { id: 6, name: 'Сб', status: false, startTime: '00:00', finishTime: '23:59' },
                            { id: 0, name: 'Вс', status: false, startTime: '00:00', finishTime: '23:59' }
                        ],
                        start: '',
                        finish: ''
                    }    
