                ...
                <v-row>
                    <v-col>
                        <div style="padding: 0px; margin-bottom: 0px;">
                            <v-btn style="background-color: #fff; color: #333;" outline @click.prevent="router.push('/advertisers/users')">Назад</v-btn>
...
<script setup>
    ...
    const submitForm = async (recordInfo) => {
        ...
        // try {
            ...
            const scopeArray = []
            scopeArray.push(recordInfo.scope)
            ...
            const { data, error } = await useFetch('/api/partners', { 
                ...
                body: { 
                    ...
                    partner: (recordInfo.partner && recordInfo.partner.id) ? recordInfo.partner.id : recordInfo.partner,
